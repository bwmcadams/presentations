...
\begin{itemizecodeframe}
    ...
    \item Aiming to Release a Beta in the next 2-3 weeks
...
\begin{itemizeframe}
    \frametitle{Questions?}
        ...
        \item This presentation (if you want to see the sample code): \url{http://speakerdeck.com/u/bwmcadams/p/hammersmith}
        \item Hammersmith on GitHub (Not done yet!): \url{http://github.com/bwmcadams/hammersmith}
    \par
